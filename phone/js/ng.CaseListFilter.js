angular.module("myApp", ["ngTouch", "ngq"]).service("Data", function() {
  ...
  t.Data = o, a(), t.stopPropagation = function(t) {
    ...
    appcan.window.publish("EDZY/CaseList.toggleFilter", "")
    ...
    console.log("filter: %s", t), localStorage.setItem("EDZY/CaseList.filter", t), appcan.window.publish("EDZY/CaseList.filterChange", "")
