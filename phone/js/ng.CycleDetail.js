angular.module("myApp", ["ngq"]).service("Data", function() {
  ...
  return function() {
    var n = localStorage.getItem("EDZY/CycleDetail.cycleId");
    ...
    console.log(i), appcan.window.openToast(CR.TOAST_WAITING), appcan.request.ajax({
      ...
      success: function(n, i, c, r, s) {
        if (appcan.window.closeToast(), console.log(n), "0" != n.status) appcan.window.openToast(n.msg, SimcereConfig.ui.toastDuration);
          ...
          var l = n.data;
          l.invoiceFilesView = a(l.invoiceFiles), e(function() {
            o.cycle = n.data, o.cycle.productsView = t("joinProducts")(n.data.products), o.cycle.begin_end_View = l.beginDate + " ~ " + l.endDate
          });
  ...
  return function(e) {
    ...
    console.log(t), appcan.window.openToast(CR.TOAST_WAITING), appcan.request.ajax({
      ...
      success: function(e, o, t, n, a) {
        appcan.window.closeToast(), console.log(e), "0" != e.status ? (appcan.window.openToast(e.msg, SimcereConfig.ui.toastDuration), console.error("res error")) : (appcan.window.publish("EDZY/CycleList.refresh", "abortCycle"), appcan.window.openToast(e.msg, SimcereConfig.ui.toastDurationCb), setTimeout(function() {
  ...
  return function(e) {
    ...
    console.log(n), appcan.window.openToast(CR.TOAST_WAITING), appcan.request.ajax({
      ...
      timeout: REQUEST_TIMEOUT,
      success: function(e, o, t, n, a) {
        appcan.window.closeToast(), console.log(e), "0" != e.status ? (appcan.window.openToast(e.msg, SimcereConfig.ui.toastDuration), console.error("res error")) : (appcan.window.publish("EDZY/CycleList.refresh", "deleteCycle"), appcan.window.openToast(e.msg, SimcereConfig.ui.toastDurationCb), setTimeout(function() {
          qlib.closeCurrentWindow()
        }, SimcereConfig.ui.toastDurationCb))
      },
      error: function(e, o, t, n) {
