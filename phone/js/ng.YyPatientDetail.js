angular.module("myApp", ["ngq"]).service("Data", function() {
  ...
  return function() {
    if (!e.loading) {
        ...
        var n = {
          rId: "SH10062",//qlib.getUser().loginId,
          patientId: '187',//i,
          version: '1',
        };
  ...
  return function(o) {
    localStorage.setItem("EDZY/yyzq.caseId", o.id), void appcan.window.open("EDZY_YyCaseDetail", "YyCaseDetail.html", 10)
  }
}]).service("openCycleDetail", ["$timeout", "Data", function(e, t) {    //查看用药周期详情
  return function(o) {
    localStorage.setItem("EDZY/yyzq.cycleId", o.id), void appcan.window.open("EDZY_YyCycleDetail", "YyCycleDetail.html", 10)
  }
}]).service("cycleCreate", ["$timeout", "Data", function(e, t) {    //新增用药周期
  return function() {
    void appcan.window.open("EDZY_YyCycleCreate", "YyCycleCreate.html", 10)
  }
